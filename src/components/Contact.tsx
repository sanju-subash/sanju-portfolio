          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-3 pt-3">
                <a
                  href="mailto:sanjusubash43@gmail.com"
                ...
                >
                  ...
                  <span className="truncate">sanjusubash43@gmail.com</span>
                </a>
                <a
                  href="tel:7736683583"
                  className="flex items-center gap-3 text-xs text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white transition-colors cursor-none font-bold"
                ...
                <a
                  href="https://linkedin.com/in/sanjusubash"
                  target="_blank"
